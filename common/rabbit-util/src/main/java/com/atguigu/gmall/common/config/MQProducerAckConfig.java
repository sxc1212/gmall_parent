...
public class MQProducerAckConfig implements RabbitTemplate.ConfirmCallback,RabbitTemplate.ReturnCallback {
    ...
    /**
     * 判断这个消息是否到了交换机
     * @param correlationData  封装了一个消息，这个消息有自定义的Id 标识！
    ...
    private void retrySendMsg(CorrelationData correlationData) {
        ...
        if (retryCount>=3){
            ...
            //  覆盖缓存中的数据.
            redisTemplate.opsForValue().set(gmallCorrelationData.getId(), JSON.toJSONString(gmallCorrelationData),2, TimeUnit.MINUTES);
