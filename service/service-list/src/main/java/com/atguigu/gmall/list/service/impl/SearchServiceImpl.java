...
public class SearchServiceImpl implements SearchService {
    ...
    //  商品上架 --- 将数据封装到Goods ，并且将Goods 保存到es 中！ 具体谁能来做这件事！
    @Autowired
    ...
    public SearchResponseVo search(SearchParam searchParam) throws IOException {
        ...
        //  显示3,4条件怎么搞?  select * from skuInfo;
        //  总共10条数据 每页3条，10 3 4   9 3 3
    ...
    private SearchResponseVo parseResult(SearchResponse searchResponse) {
        ...
        //  循环遍历时，获取品牌Id 给 SearchResponseTmVo 对象，然后再将这个对象添加到集合中！
