...
public class BaseCategoryTrademarkServiceImpl extends ServiceImpl<BaseCategoryTrademarkMapper,BaseCategoryTrademark> implements BaseCategoryTrademarkService {
    ...
    public List<BaseTrademark> findTrademarkList(Long category3Id) {
        ...
        //  已知三级分类Id 求 品牌列表！
        //  base_category_trademark 记录哪个分类下有哪些品牌！ 根据category3Id base_category_trademark 获取到品牌Id ，
    ...
    public List<BaseTrademark> findCurrentTrademarkList(Long category3Id) {
        ...
        if (!CollectionUtils.isEmpty(baseCategoryTrademarkList)){
            ...
            //  参数类型是谁： 集合的泛型
            //  baseTrademarkMapper.selectList(null)  1,2,3,5,7  tmIdsList 1,3
    ...
    public void save(CategoryTrademarkVo categoryTrademarkVo) {
        ...
        if (!CollectionUtils.isEmpty(trademarkIdList)){
            ...
            //  放入集合数据  insert into values() values();
    ...
    public void removeByCategory3IdAndTmId(Long category3Id, Long tmId) {
        //  update base_category_trademark set is_deleted = 1 where  category3_id = ? and trademark_id = ?
        QueryWrapper<BaseCategoryTrademark> baseCategoryTrademarkQueryWrapper = new QueryWrapper<>();
        baseCategoryTrademarkQueryWrapper.eq("category3_id",category3Id);
