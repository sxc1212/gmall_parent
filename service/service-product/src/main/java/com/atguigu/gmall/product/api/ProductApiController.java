...
public class ProductApiController {
    ...
    //  定义根据skuId 获取skuInfo + skuImage 集合数据！
    //  /api/product/inner/getSkuInfo/{skuId}  -- inner 内部数据接口 这个接口表明只能给内部的微服务模块使用！
    ...
    //  根据spuId 获取数据： 返回值！ JSON.toJsonString(map);
